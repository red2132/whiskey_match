...
function GetWhiskeyDetail({ whiskeyId }: { whiskeyId: string }): JSX.Element {
  ...
  return (
    <div className="w-full relative">
      <Image
        ...
        src={whiskeyInfo?.whiskey_bg_image || ""}
        alt="위스키 배경 이미지"
        height={640}
        width={720}
      />
      <Image
        ...
        src={whiskeyInfo?.whiskey_thumbnail_image || ""}
        alt="위스키 썸네일 이미지"
        height={250}
        width={250}
      />
      ...
      <div className="text-[#ffffff] text-left text-[10px] md:text-[22px] absolute left-[5%] top-[70%] flex flex-col justify-start w-[45%] break-words">
